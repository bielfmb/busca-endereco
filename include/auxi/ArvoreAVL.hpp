...
class ArvoreAVL {
    public:
         ...
         * @typedef Callback
         * 
         * @brief Função utilizada para visitar cada elemento da árvore.
         * 
         * @param chave Referência para a chave armazenada no nó.
         * @param dado Referência para o dado associado à chave.
        ...
        /**
         * @brief Aplica uma função de callback a cada nó da árvore.
         *
         * @param c Função callback a ser chamada para cada elemento.
         * @param contexto Utilizado para que o callback tenha acesso à dados 
         * externos
         */
